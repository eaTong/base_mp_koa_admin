...
export default class AppStore {
  ...
  @observable menus = [];
  @observable activeKey = '/admin/timeline';
  @observable lastKey = '';
  @observable tabList = [
    // {path: '/admin/index', name: '首页', optionalData: {}},
    {path: '/admin/timeline', name: '介绍时间轴', optionalData: {}},
    {path: '/admin/speak', name: '寄语', optionalData: {}},
    {path: '/admin/lightup', name: '助力', optionalData: {}},
    {path: '/admin/notice', name: '公告管理', optionalData: {}},
  ];

  @action
  async login(values) {
    const data = await ajax({data: values, url: '/api/admin/user/login'});
    console.log(data);
    this.loginUser = data;
